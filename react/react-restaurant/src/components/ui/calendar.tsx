...
// import { ChevronLeft, ChevronRight } from "lucide-react" // Removed unused import
import { DayPicker } from "react-day-picker"

import { cn } from "@/lib/utils"
// Definindo buttonVariants localmente
const buttonVariants = () => {
  return "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-zinc-950 dark:focus-visible:ring-zinc-300";
}
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          buttonVariants(), // Removed variant argument
      ...
      // Removendo componentes customizados para evitar erros de tipagem
      {...props}
    />
  )
}
