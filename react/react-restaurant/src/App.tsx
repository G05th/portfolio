  ...
  return (
    <div className="font-sans flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <Outlet /> {/* This will render either Home or Contato */}
      </main>
      <Footer />

      {/* Persistent WhatsApp Button - Keep if required globally */}
      <a
        href="https://wa.me/+244900000000" // Placeholder number - update if needed
        target="_blank"
